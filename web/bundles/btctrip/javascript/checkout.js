...
*/
registerNameSpace("CheckoutFlights.Checkout");
CheckoutFlights.Checkout = (function (e, h) {
    var f;
    var d;
    ...
    function g(i) {
        ...
        window.X_UOW = i.uow;
        CheckoutFlights.Common.Modules.Detail.init(i.messages.detail);
        CheckoutFlights.Checkout.Modules.Form.init(i)
    }
    function a() {
        return f
    }
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form");
CheckoutFlights.Checkout.Modules.Form = (function (g, c) {
    var b;
    var k;
    var a;
    ...
    function o(q) {
        ...
        a = CheckoutFlights.Common.Validator;
        CheckoutFlights.Checkout.Modules.Form.Passengers.init(q.flowDependencies, a, q.fastCheckoutData);
        CheckoutFlights.Checkout.Modules.Form.Payment.init(b, a);
        CheckoutFlights.Checkout.Modules.Form.Invoice.init(a);
        CheckoutFlights.Checkout.Modules.Form.Contact.init(a, q.fastCheckoutData);
        CheckoutFlights.Checkout.Modules.Form.Agreement.init(q.messages.form.agreement, a);
        CheckoutFlights.Checkout.Modules.Form.Additionals.init(a);
        CheckoutFlights.Checkout.Modules.Form.Currency.init(b);
        CheckoutFlights.Checkout.Modules.Form.Buy.init(b, a);
        if (q.flowDependencies.isNewFlight) {
            CheckoutFlights.Checkout.Modules.NewFlight.NewFlight.init(q.sessionId, q.popUpDataUrl, q.clustersOptions, q.clustersMessages)
        } else {
            if (q.flowDependencies.showInitialTransition) {
                g("#popup-initial-transition").hide();
                CheckoutFlights.Common.Utils.hideModal()
            }
        } if (!CheckoutFlights.Common.Utils.supportPlaceHolders()) {
            CheckoutFlights.Common.Utils.placeHolders(g(".input[type=text]", b))
        }
    ...
    function n(q) {
        ...
        var r = g.extend(p, q);
        CheckoutFlights.Common.Utils.openPopup(r)
    }
    function j() {
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form.Passengers");
CheckoutFlights.Checkout.Modules.Form.Passengers = (function (j, f) {
    var e;
    var p;
    var m;
    var c;
    ...
    function q(t, r, s) {
        ...
        m = CheckoutFlights.Checkout.getCountryCode();
        c = r;
        i = s;
            ...
            j(".names .input", e).on({
                focus: function (v) {
                    ...
                    j("body").on("click", "#popup-fast-checkout .item", function (x) {
                        ...
                        CheckoutFlights.Checkout.Modules.Form.removeFastCheckoutPopup()
                    })
                },
                blur: function (u) {
                    CheckoutFlights.Checkout.Modules.Form.hideFastCheckoutPopup()
                }
            })
        }
    ...
    function g(s) {
        ...
        CheckoutFlights.Common.Utils.openPopup({
            $elementTrigger: s,
    ...
    function k(v) {
        ...
        if (i[r].length) {
            ...
            CheckoutFlights.Checkout.Modules.Form.showFastCheckoutPopup(u)
        }
    }
    return {
        init: q
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form.Invoice");
CheckoutFlights.Checkout.Modules.Form.Invoice = (function (b, e) {
    var c;
    var a;
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form.Contact");
CheckoutFlights.Checkout.Modules.Form.Contact = (function (k, f) {
    var e;
    ...
    function o(q, r) {
        ...
        e.on("click", ".remove-phone", function (t) {
            ...
            if (!CheckoutFlights.Common.Validator.validateFilledInput(s)) {
                n(k(this));
                h()
            } else {
                g(k(this))
        ...
        amplify.subscribe("doValidation", function () {
            var t = CheckoutFlights.Common.Validator;
    ...
    function l(s) {
        ...
        if (j[r].length) {
            ...
            CheckoutFlights.Checkout.Modules.Form.showFastCheckoutPopup(q)
        }
    }
    return {
        init: o
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form.Agreement");
CheckoutFlights.Checkout.Modules.Form.Agreement = (function (c, f) {
    var e;
    var b;
    ...
    function d(h, g) {
        ...
        amplify.subscribe("doValidation", function () {
            var i = CheckoutFlights.Common.Validator.validateInputs(_$agreement, true).valid;
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form.Currency");
CheckoutFlights.Checkout.Modules.Form.Currency = (function (c) {
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form.Additionals");
CheckoutFlights.Checkout.Modules.Form.Additionals = (function (e, c) {
    var d;
    var a;
    ...
    function i(j) {
        ...
        d.on("click", ".remove-voucher", function (l) {
            ...
            if (!CheckoutFlights.Common.Validator.validateFilledInput(k)) {
                h(e(this));
                b()
            } else {
                g(e(this))
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form.Payment");
CheckoutFlights.Checkout.Modules.Form.Payment = (function (f, h) {
	var e;
...
registerNameSpace("CheckoutFlights.Checkout.Modules.Form.Buy");
CheckoutFlights.Checkout.Modules.Form.Buy = (function (f, h) {
    var e;
    var c = true;
    var d;
    var b;
                    ...
                    $.post(
                    		...
                    		function(data) {
                    			if (data.success && (data.gateway == 'BitPay' || data.gateway == 'GoCoin')) {
                    				...
                    				$('#payment-msg').text('At this moment we can not generate the invoice. Please try in some minutes.');
                    				$('#payment-msg').addClass('error');
                    			}
                    		});
                    
                } else {
                    CheckoutFlights.Checkout.Modules.Form.sendErrors();
                    c = true;
...
registerNameSpace("CheckoutFlights.Common.Modules.Detail");
CheckoutFlights.Common.Modules.Detail = (function (c, e) {
    var b;

    function d(f) {
        logger.info("[INFO] Initializing Detail.");
        b = c("#detail");
        CheckoutFlights.Common.Modules.Detail.Prices.init();
        CheckoutFlights.Common.Modules.Detail.Itinerary.init(f.itinerary);
...
registerNameSpace("CheckoutFlights.Common.Modules.Detail.Prices");
CheckoutFlights.Common.Modules.Detail.Prices = (function (c, e) {
    var a;
...
registerNameSpace("CheckoutFlights.Common.Modules.Detail.Itinerary");
CheckoutFlights.Common.Modules.Detail.Itinerary = (function (c, e) {
    var b;
...
registerNameSpace("CheckoutFlights.Common.Validator");
CheckoutFlights.Common.Validator = (function (i, e) {
    ...
    function d(x, w) {
        ...
        if (u == "checkbox") {
            if (!x.is(":checked") && CheckoutFlights.Common.Utils.isRequired(x)) {
                v = false;
                s = "field_empty"
            } else {
                v = true
            ...
            if (!c(x) && CheckoutFlights.Common.Utils.isRequired(x)) {
                v = false;
                s = "field_empty"
            } else {
