...
typeof jQuery == "undefined" ? define("jquery", ["libs.jquery"], function () {
        ...
        e("input", n).change(function () {
            ...
            if (r.size() && i.size()) {
                ...
                if (f && l && (r.find("input").size() > 1 || i.find("input").size() > 1)) {
                    ...
                    a = "_" + u + "_" + h, t.items[s].itinerariesBox.frequentFlyerInfo && (o = t.items[s].itinerariesBox.matchingInfoMap[a].frequentFlyerInfo.points, n.find(".distance").html(o))
                }
            } else r.size() && (s = e(this).closest(".item").data("itineraryInfo").clusterIndex, u = r.find("input:checked").closest(".item").data("itineraryInfo").itineraryIndex, a = "_" + u + "_-1", t.items[s].itinerariesBox.frequentFlyerInfo && (o = t.items[s].itinerariesBox.matchingInfoMap[a].frequentFlyerInfo.points, n.find(".distance").html(o)))
        })
    }
...
}), define("modules/clusters/fare", ["jquery", "amplify", "modules/clusters/common", "core-flights/logger"], function (e, t, n, r) {
    ...
    function a(e, n, u, a) {
        ...
        if (s === "true") {
            ...
            var f = i.result.data.items[u].provider,
                l = o;
            l = l.replace("{hash}", e.hash), l = l.replace("{version}", e.version), l = l.replace("{itineraryId}", n), l = l.replace("{clusterIndexTraking}", a), l = l.replace("{provider}", f), window.location = l
    ...
    function d(n, i, s, c, h, d) {
        o.info("Initializing Actions."), u = h, a = n, f = d, l = i, p = s, t.subscribe("changeCurrency", function (e) {
            p = e
        }), e(".icon-mail", u).on("click", function (n) {
            var i = e(this).parents(".cluster");
            t.publish("validateCluster", i), r.isValid(i, l) && v(this, c.emailTitle)
        ...
        }), e(".payments", u).on("click", function (e) {
            e.preventDefault(), E(c.paymentsTitle, a, i, this)
        }), e("a.frequent-flyer", u).on("click", function (t) {
            S(e(this), a, c)
        })
    }
    function v(t, n) {
        var o = e(t).parents(".cluster");
        e("#popup-email-success .popup-close").click(), e("#popup-email-error .popup-close").click();
        var u = {
            ticketHash: f.hash,
            version: f.version,
            itineraryHash: r.getItineraryHash(o, a.result.data.items, l),
            currencyCode: p
        };
        s.togglePopup({
            elementTrigger: t,
            id: "popup-email",
            title: n,
            $template: e("#popup-email-template"),
            $data: u,
            popupPosition: "bottom",
            indicator: !1,
            indicatorPosition: "top",
            dynamic: !1
        }), e("#email .receiver").val(""), e("#email .currencyCode").val(p), e("#email .message").val(e("#email .message").data("originalValue")), i.placeHolders(e("#email .placeholder")), e("#email").find("input, textarea").removeAttr("disabled"), e("#email").find("input, textarea, .btn-send").removeClass("disabled"), C(e("#email .required")), e("#email .required .input").on("blur", function () {
            var t = e(this).parent();
            w(t)
        }), e("#email .btn-send").unbind("click").on("click", function (n) {
            e(this).hasClass("disabled") || m(e("#email"), t)
        })
    }
    function m(t, n) {
        w(t.find(".required")) && (t.find("input, textarea").attr("disabled", "disabled"), t.find("input, textarea, .btn-send").addClass("disabled"), e.ajax({
            url: t.attr("action"),
            type: t.attr("method"),
            dataType: "json",
            data: g(t),
    ...
    function g(t) {
        ...
        return t.find(".input").each(function () {
            var t = e(this).attr("name"),
                r = e(this).attr("type") == "checkbox" ? e(this).attr("checked") == "checked" ? !0 : !1 : e(this).attr("value");
            n[t] = r
        }), c = t.find("input[name='name']").attr("value"), h = t.find("input[name='toEmail']").attr("value"), n
    }
    function y(t, n) {
        e("#popup-email .popup-close").click();
        if (t.result.data.status.code != "SUCCEEDED") b(n);
        else {
            var r = {
                fromName: c,
                fromEmail: h
            ...
            s.togglePopup({
                elementTrigger: n,
                id: "popup-email-success",
                title: "",
                $template: e("#popup-email-success-template"),
                $data: r,
                popupPosition: "bottom",
                indicator: !1,
                indicatorPosition: "top",
    ...
    function b(t) {
        e("#popup-email .popup-close").click(), s.togglePopup({
            elementTrigger: t,
            id: "popup-email-error",
            title: "",
            $template: e("#popup-email-error-template"),
            popupPosition: "bottom",
            indicator: !1,
            indicatorPosition: "top",
            dynamic: !1
    ...
    function w(t) {
        ...
        return t.each(function () {
            var t = e(this),
                r = e(".input", t);
            r.val() === "" ? (C(t), N(t, "empty"), n = !1) : (C(t), r.data("validations") && r.data("validations").email && (i.validateEmail(r) ? C(t) : (N(t, "invalid"), n = !1)))
        }), n
    }
    function E(t, n, i, o) {
        var u = r.getClusterIndex(e(o).parents(".cluster")),
            a;
        i === "ONEWAY" || i === "ROUNDTRIP" ? a = n.result.data.items[u].itinerariesBox.paymentsInfo : a = n.result.data.items[u].itinerary.paymentsInfo, s.togglePopup({
            elementTrigger: o,
            id: "popup-payments",
            title: t,
            $template: e("#popup-payments-template"),
            $data: a,
            popupPosition: "bottom",
            indicator: !1,
            indicatorPosition: "top"
        }), _$popupPayments = e("#popup-payments"), e(".payments-info", _$popupPayments).length && T()
    }
    function S(t, n, r) {
        var i = Handlebars.compile(e("#frequent-flyer-template").html()),
            o = x(t, n),
            u = {
                points: o.points.formatted,
                program: o.program,
                unit: r.frequentflyer.units[o.distanceUnit],
                pointsProgram: r.frequentflyer.pointsPrograms[o.airline.code],
                airline: o.airline.description
            }, a = i(u);
        s.togglePopup({
            elementTrigger: t,
            id: "popup-frequent-flyer",
            $content: e(a),
            popupPosition: "bottom",
            indicator: !1,
            indicatorPosition: "top"
    ...
    function x(t, n) {
        var i = null,
            s = r.getClusterIndex(e(t).parents(".cluster")),
            o = n.result.data.items[s];
        return o.itinerariesBox !== undefined ? i = o.itinerariesBox.frequentFlyerInfo : i = o.itinerary.itineraryInfo.frequentFlyerInfo, i
    }
    function T() {
        var t = 0,
            n = 7,
            r = e(".payments-container ul", _$popupPayments),
            i = r.length,
            s = r.first(),
            o = s.outerHeight(),
            u = s.outerWidth(),
            a = e(".payments-next", _$popupPayments),
            f = e(".payments-prev", _$popupPayments);
        e(".payments-info", _$popupPayments).height(o), e(".payments-arrow", _$popupPayments).css({
            top: Math.round(o / 2 - a.height() / 2)
        }), e(".payments-container", _$popupPayments).width(i * u), a.on("click", function () {
            e(".payments-prev", _$popupPayments).show(), t++, n++, n <= i && (e(".payments-container", _$popupPayments).animate({
                left: "-=" + u
            }), n == i && e(".payments-next", _$popupPayments).hide())
        }), f.on("click", function () {
            e(".payments-next", _$popupPayments).show(), t--, n--, t >= 0 && (e(".payments-container", _$popupPayments).animate({
                left: "+=" + u
            }), t === 0 && e(".payments-prev", _$popupPayments).hide())
        })
    }
    function N(t, n) {
    ...
    function p(s) {
        r.info("Initializing Filters."), o = e("#filters"), u = n.compile(e("#filters-template").html()), a = s, t.subscribe("doSearch", function (e) {
            ...
            r.info("Applying search filters."), f = e, E(t), (i.id == "history" || i.id == "matrix") && k(n)
...
}.call(this), define("core-flights/custom/moment", function () {}), define("core-flights/modules/flights-alerts/flights-alerts", ["jquery", "amplify", "handlebars", "core-flights/logger", "core-flights/popup", "nibbler.alerts", "core-flights/tmpl-helpers", "core-flights/custom/moment"], function (e, t, n, r, i, s) {
    function h(s) {
