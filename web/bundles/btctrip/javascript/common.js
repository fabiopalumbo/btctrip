...
Handlebars.registerHelper("blockHelperMissing", function (f, d) {
    var a = d.inverse || function () {}, h = d.fn;
    var c = "";
...
var handlebars = (function () {
    var f = {
        ...
        performAction: function b(g, j, k, n, m, i, l) {
            var h = i.length - 1;
            switch (m) {
                case 1:
                    return i[h - 1];
                ...
                case 21:
                    this.$ = [
                        [i[h - 2]].concat(i[h - 1]), i[h]
                    ];
                    break;
                case 22:
                    this.$ = [
                        [i[h - 1]].concat(i[h]), null
                    ];
                    break;
                case 23:
                    this.$ = [
                ...
                for (var q = 0; q < s.length; q++) {
                    ...
                    if (p) {
                        ...
                        this.yylloc = {
                            ...
                            last_column: n ? n[n.length - 1].length - 1 : this.yylloc.last_column + p[0].length
                        };
                        this.yytext += p[0];
                        this.match += p[0];
                        this.matches = p;
...
(function (f, e) {
    ...
    e.prototype = {
        ...
        nextOpcode: function (r) {
            var o = this.environment.opcodes,
                m = o[this.i + r],
                l, p;
            var q, i;
            if (m === "DECLARE") {
        ...
        programExpression: function (k) {
            ...
            var p = this.environment.children[k],
                o = p.depths.list;
...
registerNameSpace("CheckoutFlights.Common.Utils");
CheckoutFlights.Common.Utils = (function (h, c) {
    function e() {
    ...
    function i() {
        if (!h(".modal").length) {
            h("body").append(h("<div class='modal' />"))
        } else {
            h(".modal").show()
        }
    }
    ...
    function g(k, j) {
        k.each(function () {
            var n = h(this);
            var l = n.attr("placeholder");
            n.attr("placeholder", j);
            var m = n.attr("placeholder");
            if ((n.val() == "" || n.val() == l) && l != "" && l != c) {
        ...
        k.on({
            focus: function (l) {
                if (h(this).val() == h(this).attr("placeholder")) {
                    h(this).val("");
                    h(this).removeClass("placeholder")
                }
            },
            blur: function (l) {
                if (h(this).val() == "") {
                    h(this).addClass("placeholder");
    ...
    function d(k) {
        var j = new CheckoutFlights.Common.Popup(k);
        return j
    }
    function b(j) {
        var k = j.toLowerCase();
        k = k.replace(new RegExp(/[àáâãäå]/g), "a");
        k = k.replace(new RegExp(/ç/g), "c");
        k = k.replace(new RegExp(/[èéêë]/g), "e");
        k = k.replace(new RegExp(/[ìíîï]/g), "i");
        k = k.replace(new RegExp(/ñ/g), "n");
        k = k.replace(new RegExp(/[òóôõö]/g), "o");
        k = k.replace(new RegExp(/[ùúûü]/g), "u");
        k = k.replace(new RegExp(/[ýÿ]/g), "y");
        k = k.replace(new RegExp(/(<.*?>)/ig), "");
        return k
    }
    function f(k) {
        var j = false;
    ...
    return {
        ...
        showModal: i,
        hideModal: a,
        supportPlaceHolders: e,
        placeHolders: g,
        cleanString: b,
        isRequired: f
    }
}(jQuery));
registerNameSpace("CheckoutFlights.Common.TmplHelpers");
CheckoutFlights.Common.TmplHelpers = (function (a, b) {
    Handlebars.registerHelper("_each", function (c, m) {
        var e = "";
        var h = c.length;
        var g = 0;
        var k = a.isEmptyObject(m.hash);
        for (var f = 0, d = h; f < d; f++) {
            var l = {};
            l.data = c[f];
            l._data = {};
            l._data.index = g;
    ...
    Handlebars.registerHelper("debug", function (c) {
        console.log("\nCurrent Context");
        console.log("====================");
        console.log(this);
    ...
    Handlebars.registerHelper("get", function (e, d) {
        if (e.hash) {
            if (e.hash.array) {
                var f = e.hash.array;
                f = f.split(",");
                return f[e.hash.index]
            } else {
                if (e.hash.object) {
                    var c = e.hash.object;
                    c = a.parseJSON(c);
            ...
            return d(e[d.hash.index])
        }
    });
    Handlebars.registerHelper("compare", function (d, h, g) {
        if (arguments.length < 3) {
            throw new Error("Handlerbars Helper 'compare' needs 2 parameters")
        } else {
            var f = g.hash.operator || "==";
            var d = d === "null" ? null : d;
            var h = h === "null" ? null : h;
            var e = {
                "==": function (i, j) {
            ...
            if (!e[f]) {
                throw new Error("Handlerbars Helper 'compare' doesn't know the operator " + f)
            } else {
                var c = e[f](d, h);
                if (c) {
                    return g.fn(this)
    ...
    Handlebars.registerHelper("even_odd", function (c) {
        return (c % 2 === 0 ? "even" : "odd")
    });
    Handlebars.registerHelper("calcule", function (c, f, e) {
        if (arguments.length < 3) {
            throw new Error("Handlerbars Helper 'compare' needs 2 parameters")
        } else {
            var g = e.hash.symbol || "+";
            ...
            if (!d[g]) {
                throw new Error("Handlerbars Helper 'compare' doesn't know the symbol " + g)
            } else {
                return d[g](c, f)
            }
        }
...
registerNameSpace("CheckoutFlights.Common.Popup");
CheckoutFlights.Common.Popup = function (j) {
    if (j.$popupTemplate) {
        var c = Handlebars.compile(j.$popupTemplate.html())
    } else {
        var c = Handlebars.compile($("#popup-checkout-template").html())
    }
    var e = null;
    var i = {
        $template: null,
    ...
    var b = function () {
        ...
        if (j.showModal) {
            e.addClass("modal-popup");
            CheckoutFlights.Common.Utils.showModal()
        }
        e.addClass(i.id);
        if (i.popupClass) {
            e.addClass(i.popupClass)
        }
        d();
        h()
    };
    var f = function () {
        $(".popup-close-button", e).click(function () {
            e.hide();
            if (i.showModal) {
        ...
        $(document).keyup(function (k) {
            if (k.keyCode == 27) {
                $(".popup-close-button", e).click()
            }
        })
    };
    var d = function () {
        if (j.$popupTemplate) {} else {
            if (i.dynamic) {
                $(".popup-content", e).empty()
            }
            if ($(".popup-content", e).children().length == 0) {
                if (i.$template) {
                    var k = Handlebars.compile(i.$template.html());
                    $(".popup-content", e).html(k(i.$data))
                } else {
                    if (j.clone) {
                        var l = Handlebars.compile(j.$content.clone().html());
                        $(".popup-content", e).html(l(i.$data))
                    } else {
                        $(".popup-content", e).html(i.$content.show())
                    }
                }
            }
        }
    ...
    var h = function () {
        if (i.dontClosePopup) {
            a(i.$elementTrigger, i.popupPosition, i.dynamicPosition);
            e.show()
        } else {
            e.hide();
            if (i.showModal) {
    ...
    function g() {
        var k = $(i.elementTrigger);
        switch (i.position) {
            case "left":
                e.css({
                    top: k.offset().top + (k.outerHeight() / 2) - (e.outerHeight() / 2),
                    left: k.offset().left - e.outerWidth() - 15
                });
                e.find(".popup-arrow-right").css("top", ((e.outerHeight() - 20) / 2));
                break;
            case "right":
                e.css({
                    top: k.offset().top + (k.outerHeight() / 2) - (e.outerHeight() / 2),
                    left: k.offset().left + k.outerWidth() + 15
                });
                e.find(".popup-arrow-left").css("top", ((e.outerHeight() - 20) / 2));
                break;
            case "top":
                var l = k.offset().top - e.outerHeight() - 15;
                if (i.top) {
                    l = l - i.top
                }
                e.css({
                    top: l,
                    left: k.offset().left + (k.outerWidth() / 2) - (e.width() / 2)
                });
                e.find(".popup-arrow-bottom").css("left", ((e.outerWidth() - 20) / 2) - 10);
                break;
            case "bottom":
                e.css({
                    top: k.offset().top + k.outerHeight() + 15,
                    left: k.offset().left + (k.outerWidth() / 2) - (e.width() / 2)
                });
                e.find(".popup-arrow-top").css("left", ((e.outerWidth() - 20) / 2) - 10);
                break;
            case "bottom-left":
                e.css({
                    top: k.offset().top + k.outerHeight() + 5,
                    left: k.offset().left
                });
                e.find(".popup-arrow-top").not(".arrow-border").css("left", 10);
                break;
            case "bottom-middle-left":
                e.css({
                    top: k.offset().top + k.outerHeight() + 15,
                    left: k.offset().left - (e.width() / 2) - 90
                });
                e.find(".popup-arrow-top").css("left", ((e.outerWidth()) / 2) + 95);
                break;
            case "bottom-middle-right":
                e.css({
                    top: k.offset().top + k.outerHeight() + 15,
                    left: k.offset().left + 5
                });
                e.find(".popup-arrow-top").css("left", 0);
                break;
            case "fixed":
                e.css({
            ...
            case "center":
            default:
                var l = $(window).scrollTop() + (($(window).height() - e.outerHeight()) / 2);
                if (i.top) {
                    l = i.top
                }
                if (l < 0) {
                ...
                e.css({
                    top: l,
                    left: ($("body").width() - e.outerWidth()) / 2
                });
                e.find(".popup-arrow-top").css("left", ((e.outerWidth() - 20) / 2) - 10)
        }
    }
    var a = function (n, k, q) {
        i.elementTrigger = n;
        i.position = k;
        i.dynamicPosition = q;
        var m = $(i.elementTrigger);
        if (i.dynamicPosition) {
            var p = m.offset().left + (m.outerWidth() / 2);
            var o = p + (e.outerWidth() / 2);
            if ($(window).width() < o) {
                var l = o - $(window).width();
                e.css({
                    top: m.offset().top + 35,
                    left: m.offset().left + (m.outerWidth() / 2) - (e.outerWidth() / 2) - l - 13
                });
                var r = o - p + l - 13;
                $(".popup-arrow", e).css("left", r)
            } else {
                g()
            }
        } else {
