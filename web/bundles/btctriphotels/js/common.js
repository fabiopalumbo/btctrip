...
registerNameSpace("CheckoutHotels.Common.Utils");
CheckoutHotels.Common.Utils = (function (h, c) {
    function e() {
    ...
    function d(k) {
        var j = new CheckoutHotels.Common.Popup(k);
        return j
    }
    function b(j) {
        var k = j.toLowerCase();
...
registerNameSpace("CheckoutHotels.Common.TmplHelpers");
CheckoutHotels.Common.TmplHelpers = (function (a, b) {
...
registerNameSpace("CheckoutHotels.Common.Popup");
CheckoutHotels.Common.Popup = function (j) {
    if (j.$popupTemplate) {
    ...
    var b = function () {
        ...
        if (j.showModal) {
            ...
            CheckoutHotels.Common.Utils.showModal()
        }
        e.addClass(i.id);
        if (i.popupClass) {
