...
class SimpleCaptcha {
	...
	public function __construct(ContainerInterface $container) {
		...
		$resourcesSymfonyPath = '@BtcTripFlightsBundle/Resources/data/simplecaptcha';
		
		$kernel = $this->container->get('kernel');
		$this->resourcesPath = $kernel->locateResource($resourcesSymfonyPath);
		
		$logger = $this->container->get('logger');
		$logger->debug("SimpleCaptcha resourcesPath: " . $this->resourcesPath);
	}
...
// 		$_SESSION[$this->session_var] = $text;
		...
		/** Output */
		// $this->WriteImage();
		$uriImage = $this->DataUri('image/png');
	...
	/**
	 * Retrieve uri formatted image of $mime type
	 * 
	 * @param unknown $mime
	 * @return string
	 */
	private function DataUri($mime) {
