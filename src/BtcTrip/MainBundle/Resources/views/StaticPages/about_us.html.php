              ...
              <div class="span10 offset1">
                ...
                <div class="profile-boxes">
                  <div class="row">
                    ...
                    <div class="span3 offset1 profile-box bajados">
                      <div class="row">
                         <div class="span2 title">
                          <h5 class="name">Diego Saez Gil</h5>
                          <h4 class="position">Advisor</h4>
                         </div>
                        <div class="span2">
                            <img alt="Diego" width="140" height="140" src="/bundles/btctrip/images/about_us/diegosgil.jpg">     
                         </div>
                        <div class="span2">
                            <a class="btn btn-medium-light btn-sm btn-circle" href="http://www.linkedin.com/in/dsaezgil" target='_blank'>
                    ...
                    <div class="span3  profile-box">
                     ...
                     <div class="span3  profile-box bajados">
                      <div class="row">
                        <div class="span2 title">
                          <h5 class="name">Wayne Cheng</h5>
                          <h4 class="position">China Manager</h4>
                        </div>
                        <div class="span2">
                            <img alt="Charlie" width="140" height="140" src="/bundles/btctrip/images/about_us/wayne.jpg">     
                         </div>
                        <div class="span2">
                            <a class="btn btn-medium-light btn-sm btn-circle" href="http://www.linkedin.com/pub/wayne-cheng/92/aa7/ba4" target='_blank'>
                              <i class="fa-icon-linkedin"></i>
                            </a>
                          </div>
                      </div>
                  ...
                  <div class="row ">
                       ...
                       <div class="span3 offset4 profile-box ">
                      <div class="row">
                        <div class="span2 title">
                   ...
                   <div class="span3 offset1 profile-box subidos">
                      <div class="row">
                        <div class="span2 title">
