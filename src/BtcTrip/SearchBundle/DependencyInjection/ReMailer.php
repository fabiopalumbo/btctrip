...
class ReMailer {
	...
	private $purchaseConfirmationTemplate = "BtcTripSearchBundle:ReMailer:buyerPaymentConfirmation.html.php";
	private $paymentConfirmationTemplate = "BtcTripSearchBundle:ReMailer:paymentConfirmationToAdmins.txt.php";
	private $tellafriendTemplate = "BtcTripSearchBundle:ReMailer:tellafriend.txt.php";
	private $betterOfferTemplate = "BtcTripSearchBundle:ReMailer:betterOffer.txt.php";
	private $betterOfferToAdminsTemplate = "BtcTripSearchBundle:ReMailer:betterOfferToAdmins.txt.php";
